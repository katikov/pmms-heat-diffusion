...
void vecsort(int** vector_vectors, int* vector_lengths, long length_outer, int* b){
...
int main(int argc, char **argv) {
    ...
    int *b = (int*)malloc(length_inner_max*sizeof(int));
    if(b == NULL) {
        fprintf(stderr, "Malloc failed...\n");
        exit(-1);
    }
    ...
    /* Sort */
    vecsort(vector_vectors, vector_lengths, length_outer, b);
